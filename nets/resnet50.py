...
from nets.switchable_norm import SwitchNorm1d,SwitchNorm2d,SwitchNorm3d
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.bn1 = SwitchNorm2d(planes)
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=1, # change
                    padding=1, bias=False)
        # self.bn2 = nn.BatchNorm2d(planes)
        self.bn2 = SwitchNorm2d(planes)
        self.conv3 = nn.Conv2d(planes, planes * 4, kernel_size=1, bias=False)
        # self.bn3 = nn.BatchNorm2d(planes * 4)
        self.bn3 = SwitchNorm2d(planes * 4)
        # self.bn3 = nn.LayerNorm(planes*4,eps=1e-6)
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.bn1 = SwitchNorm2d(64)
        # self.bn1 = nn.LayerNorm(64,eps=1e-6)
        self.relu = nn.SiLU(inplace=True)
...
class resnet50_Decoder(nn.Module):
    ...
    def _make_deconv_layer(self, num_layers, num_filters, num_kernels):
        ...
        for i in range(num_layers):
            ...
            layers.append(SwitchNorm2d(planes,momentum=self.bn_momentum))
